...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        gameSceneBackground.setScale(0.70)
...
class MainMenuScene: SKScene, SKPhysicsContactDelegate {
    // local variables to this scene
    let mainMenuSceneBackground = SKSpriteNode(imageNamed: "IMG_2922.JPG")
    ...
    override func didMove(to view: SKView) {
        ...
        mainMenuSceneBackground.zPosition = 1
...
class MainGameScene: SKScene, SKPhysicsContactDelegate {
    // local variables to this scene
    let mainGameSceneBackground = SKSpriteNode(imageNamed: "IMG_2922.JPG")
    
    let monster = SKSpriteNode(imageNamed: "IMG_2921.PNG")
    ...
    override func didMove(to view: SKView) {
        ...
        mainGameSceneBackground.zPosition = 1
        ...
        monster.position = CGPoint(x: frame.width / 2, y: 100)
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        ...
        if ((contact.bodyA.categoryBitMask | contact.bodyB.categoryBitMask) == (collisionCandyCategory | collisionMonsterCategory)){
            ...
            // sound SFX came from soundbible.com/1394-Dragon-Bite.html
            monster.run(SKAction.playSoundFileNamed("chomping.wav", waitForCompletion: false))
            contact.bodyB.node?.position.x = -500
            contact.bodyB.node?.removeFromParent()
            candiesAttackRate += 0.10
    ...
    class GameOverScene: SKScene, SKPhysicsContactDelegate {
        ...
        let gameOverSceneBackground = SKSpriteNode(imageNamed: "IMG_2922.JPG")
        ...
        override func didMove(to view: SKView) {
            ...
            gameOverSceneBackground.zPosition = 1
